  ...
  const markdownContent = (
    <div className="inline-md mt-2 text-sm leading-7 text-[var(--text)]">
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => (
            <h1 className="text-xl font-bold mt-4 mb-2 text-[var(--text)]">{children}</h1>
          ),
          h2: ({ children }) => (
            <h2 className="text-lg font-semibold mt-3 mb-1.5 text-[var(--text)]">{children}</h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-base font-semibold mt-2 mb-1 text-[var(--text)]">{children}</h3>
          ),
          p: ({ children }) => (
