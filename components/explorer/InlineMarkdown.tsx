  ...
  const markdownContent = (
    ...
    >
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => (
            <h1 className="text-xl font-bold mt-5 mb-3 text-[var(--accent)] border-b border-[var(--accent)]/20 pb-1.5">{children}</h1>
          ),
          h2: ({ children }) => (
            <h2 className="text-lg font-semibold mt-4 mb-2 text-[var(--accent)]">{children}</h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-base font-semibold mt-3 mb-1.5 text-[var(--accent)]/80">{children}</h3>
          ),
          p: ({ children }) => (
