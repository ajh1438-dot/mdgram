...
const CAREER: CareerItem[] = [
  {
    ...
    year: "2010",
    title: "회계사 합격",
    desc: "공인회계사(CPA) 자격 취득. 숫자 너머에 이야기가 있다는 걸 처음 배운 해.",
    accent: true,
  },
  {
    period: "2010 — 2021",
    year: "11년",
    title: "회계법인 & 증권사 IB",
    desc: "회계감사와 세무자문 등 업무를 익히고, 증권사 IB에서 딜의 세계를 경험했다. 숫자가 비즈니스 언어라는 확신을 얻은 시간.",
  },
  {
    period: "2021 — 2024",
    year: "3년",
  ...
  },
  {
    ...
    year: "NOW",
    title: "그룹사 경영관리 담당",
    desc: "그룹사의 경영관리를 담당하며 더 큰 그림을 그리고 있다. 그리고 그 옆에서, 이런 것도 만들고 있다.",
    current: true,
  },
];
